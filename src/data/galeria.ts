...
export const trabajos: Trabajo[] = [
  {
    ...
    titulo: 'Almendra negra con efecto carey',
    categorias: ['manos', 'gel', 'diseno'],
    alt: 'Uñas almendradas en negro con efecto carey y una flor difuminada, sobre adelfas rosas',
  ...
  },
  {
    ...
    titulo: 'Francesa babyboomer nude',
  ...
  },
  {
    ...
    titulo: 'Rosa roja pintada a mano',
    categorias: ['manos', 'diseno'],
  ...
  },
  {
    ...
    titulo: 'Nude natural de alto brillo',
    categorias: ['manos'],
  ...
  },
  {
    ...
    titulo: 'Degradado lila y negro con pedrería',
    categorias: ['manos', 'gel', 'diseno'],
  ...
  {
    imagen: pedicuraRojo,
    titulo: 'Pedicura roja a juego',
    categorias: ['pies'],
    alt: 'Pedicura en rojo intenso sobre uñas cortas de los pies, junto a una manicura roja',
    descripcion: 'Pedicura en rojo intenso sobre uñas cortas, fotografiada junto a la manicura a juego.',
    destacada: true,
  },
  {
    imagen: nudeCremoso,
    titulo: 'Almendra corta en nude cremoso',
    categorias: ['manos'],
  ...
  },
  {
    ...
    titulo: 'Turquesa degradado con mármol',
    categorias: ['manos', 'diseno'],
  ...
  {
    imagen: lilaPastel,
    titulo: 'Almendra lila con purpurina',
  ...
  {
    imagen: rojoDisenoBn,
    titulo: 'Rojo gráfico en blanco y negro',
    categorias: ['manos', 'diseno'],
  ...
  },
  {
    ...
    titulo: 'Coral y rosa con purpurina',
    categorias: ['manos', 'diseno'],
  ...
  {
    imagen: coralLiso,
    titulo: 'Almendra coral de brillo espejo',
    categorias: ['manos'],
  ...
  },
  {
    ...
    titulo: 'Fucsia tornasolado violeta',
    categorias: ['manos'],
  ...
  },
  {
    ...
    titulo: 'Degradado rosa sobre flores blancas',
    categorias: ['manos', 'diseno'],
  ...
  },
  {
    ...
    titulo: 'Francesa neón multicolor con extensión',
  ...
  },
  {
    ...
    titulo: 'Degradado naranja y coral',
    categorias: ['manos'],
  ...
  },
  {
    ...
    titulo: 'Rosa neón con francesa invertida',
    categorias: ['manos', 'diseno'],
  ...
  },
  {
    ...
    titulo: 'Rosa neón con flores multicolor',
    categorias: ['manos', 'diseno'],
  ...
  {
    imagen: neonArcoiris,
    titulo: 'Neón multicolor con arcoíris',
    categorias: ['manos', 'diseno'],
  ...
  },
  {
    ...
    titulo: 'Rojo clásico en forma almendrada',
    categorias: ['manos'],
    alt: 'Manicura roja brillante en uñas largas de forma almendrada',
    descripcion: 'Manicura roja lisa y brillante sobre uñas largas de forma almendrada.',
  },
  {
    imagen: rojoClasicoCorta,
    titulo: 'Rojo clásico en uña corta',
    categorias: ['manos'],
    alt: 'Manicura roja brillante en uñas cortas y redondeadas',
    descripcion: 'Rojo intenso y uniforme en una manicura corta, redondeada y atemporal.',
  },
  {
    imagen: turquesaLisoCuadrada,
    titulo: 'Turquesa liso en forma cuadrada',
    categorias: ['manos'],
    alt: 'Manicura turquesa brillante en uñas cuadradas',
    descripcion: 'Turquesa vibrante y brillante sobre uñas cuadradas de longitud corta.',
  },
  {
    imagen: turquesaLisoManicura,
    titulo: 'Manicura turquesa de brillo espejo',
    categorias: ['manos'],
    alt: 'Manicura turquesa brillante en uñas de forma cuadrada',
    descripcion: 'Manicura turquesa lisa, luminosa y de acabado espejo en ambas manos.',
  },
  {
    imagen: francesTurquesaNude,
    titulo: 'Francesa turquesa sobre base nude',
    categorias: ['manos', 'diseno'],
    alt: 'Uñas nude con punta francesa en turquesa',
    descripcion: 'Base nude translúcida con puntas francesas turquesa de acabado brillante.',
  },
  {
    imagen: francesTurquesaCorta,
    titulo: 'Francesa turquesa corta y redondeada',
    categorias: ['manos', 'diseno'],
    alt: 'Uñas cortas nude con francesa turquesa y brillo',
    descripcion: 'Puntas turquesa sobre base nude en una manicura corta, limpia y luminosa.',
  },
  {
    imagen: rosaPastelAlmendra,
    titulo: 'Rosa pastel cremoso almendrado',
    categorias: ['manos'],
    alt: 'Manicura rosa pastel brillante en uñas almendradas',
    descripcion: 'Rosa pastel cremoso y brillante sobre uñas largas de forma almendrada.',
  },
  {
    imagen: pedicuraRosaPastel,
    titulo: 'Pedicura rosa pastel brillante',
    categorias: ['pies'],
    alt: 'Pedicura rosa pastel brillante en uñas de los pies',
    descripcion: 'Esmaltado rosa pastel brillante en las uñas de los pies, suave y luminoso.',
  },
  {
    imagen: rosaNeonFlores,
    titulo: 'Rosa neón, verde agua y flores',
    categorias: ['manos', 'diseno'],
    alt: 'Manicura rosa neón y verde agua con una uña decorada con flores',
    descripcion: 'Manicura de contraste en rosa neón y verde agua, con una uña floral multicolor.',
    destacada: true,
  },
  {
    imagen: francesTurquesaFloral,
    titulo: 'Francesa turquesa con flores blancas',
    categorias: ['manos', 'diseno'],
    alt: 'Francesa turquesa sobre nude con flores blancas pintadas a mano',
    descripcion: 'Puntas turquesa sobre nude con flores blancas pintadas a mano en las uñas de acento.',
  },
  {
    imagen: pedicuraRosaCorta,
    titulo: 'Pedicura rosa pastel corta',
    categorias: ['pies'],
    alt: 'Pedicura rosa pastel uniforme en uñas cortas de los pies',
    descripcion: 'Esmaltado rosa pastel uniforme en uñas cortas de los pies, con acabado brillante.',
  },
]
